          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-between">
                ...
                {/* Añade un div para los elementos a la derecha */}
                    ...
                    <a
                      ...
                      className={classNames(
                        item.current
                          ...
                          : 'text-orange-600 hover:bg-gray-700 hover:text-white',
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-neutral-700 text-red-600' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
